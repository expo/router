...
There are many applications for the new routing system. Our most important goal is to make it fast and easy to create, maintain, and scale apps with nested native navigation.
...
### Searchable, shareable, and scalable

Expo Router auto generates links for each leaf route in the app. This empowers users to open and share the entirety of the app instantly with anyone. This feature is critical for content-driven applications like social media, news, and e-commerce, really anything with multiple pages.
