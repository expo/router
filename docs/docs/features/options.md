...
Qualified layouts, like the ones found in `expo-router` (Stack, Tabs, Drawer, Layout) have a static `Screen` component which can be used to configure the behavior of a route declaratively.
