...
//    if let registry = ModuleRegistryProvider.getSingletonModule(for: ExpoHeadModule.self) as? ExpoHeadModule {
//      registry.onActivityChangedFunc()
//    }
    ...
    ExpoHeadModule.sendEvent(onActivityChanged, [:])
